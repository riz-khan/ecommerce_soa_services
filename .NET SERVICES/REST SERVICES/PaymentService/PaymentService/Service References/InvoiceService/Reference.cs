...
namespace Payment_Service.InvoiceService {
    ...
    public interface IInvoiceRegistry {
        ...
        Payment_Service.InvoiceService.Invoice GetInvoice(string invoiceId);
        
        [System.ServiceModel.OperationContractAttribute(Action="uk.ac.bcu.soa.wcf/IInvoiceRegistry/GetInvoice", ReplyAction="uk.ac.bcu.soa.wcf/IInvoiceRegistry/GetInvoiceResponse")]
        System.Threading.Tasks.Task<Payment_Service.InvoiceService.Invoice> GetInvoiceAsync(string invoiceId);
        ...
        Payment_Service.InvoiceService.Invoice[] GetAllInvoices();
        
        [System.ServiceModel.OperationContractAttribute(Action="uk.ac.bcu.soa.wcf/IInvoiceRegistry/GetAllInvoices", ReplyAction="uk.ac.bcu.soa.wcf/IInvoiceRegistry/GetAllInvoicesResponse")]
        System.Threading.Tasks.Task<Payment_Service.InvoiceService.Invoice[]> GetAllInvoicesAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IInvoiceRegistryChannel : Payment_Service.InvoiceService.IInvoiceRegistry, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class InvoiceRegistryClient : System.ServiceModel.ClientBase<Payment_Service.InvoiceService.IInvoiceRegistry>, Payment_Service.InvoiceService.IInvoiceRegistry {
        ...
        public Payment_Service.InvoiceService.Invoice GetInvoice(string invoiceId) {
            return base.Channel.GetInvoice(invoiceId);
        }
        
        public System.Threading.Tasks.Task<Payment_Service.InvoiceService.Invoice> GetInvoiceAsync(string invoiceId) {
            return base.Channel.GetInvoiceAsync(invoiceId);
        }
        
        public Payment_Service.InvoiceService.Invoice[] GetAllInvoices() {
            return base.Channel.GetAllInvoices();
        }
        
        public System.Threading.Tasks.Task<Payment_Service.InvoiceService.Invoice[]> GetAllInvoicesAsync() {
